...
- Create Angular project with ng: `ng new teste-tecnico2.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`teste-tecnico2.client.esproj`).
